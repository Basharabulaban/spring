...
public class TodoResource {
	...
	public List<Todo> getAllTodos(@PathVariable String username) throws InterruptedException { // throws InterruptedException
	...
	//
	//solved by @PathVariable "message": "Optional int parameter 'id' is present but cannot be translated into a null value due to being declared as a primitive type. Consider declaring it as object wrapper for the corresponding primitive type."
...
// use Talend API Tester - Free Edition
	...
	public ResponseEntity<Todo> updateTodos(@PathVariable String username, @PathVariable long id,@RequestBody Todo todo) {
	...
	public ResponseEntity<Todo> addNewTodos(@PathVariable String username,@RequestBody Todo todo) {
